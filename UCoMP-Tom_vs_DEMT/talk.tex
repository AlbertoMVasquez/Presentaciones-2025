...
\salto
\rojo{Fede: los resultados de las diapos 4 y 5 están copiados de la presentación que di en CO la visita pasada, entiendo que estos NO tienen el ajuste de KCOR. Cuando veas esto a la vuelta te pido actualices los gráficos (podés subirlos vos mismo al repo, con igual ombre, y avisarme que haga pull).}
\end{itemize}
}}
